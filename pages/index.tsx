                        ...
                        <div className= 'mx-2 p-2'>
                          ...
                          <div className='flex flex-col flex-y-2'>
                            ...
                            <div className="my-3 flex items-center gap-x-2"> 
                              <Avatar size ='sm' name= {owner.firstName} src={pic.owner.picture} />
                              <h1 className="text-[12px]">Like By <span className="font-semibold">{pic.owner.firstName}{pic.owner.lastName}</span> and <span className="font-semibold">{post.likes} others </span></h1>
                            </div>
